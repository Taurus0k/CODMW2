...
init()
{
	...
	thread scripts\brax_pkg_logic::init_new_hooks();
...
giveLoadout( team, class, allowCopycat )
{
	...
	//self scripts\class_script::custom_loadout(team, class , allowCopycat);
	...
	self maps\mp\perks\_perks::givePerk("specialty_specialty_steelnerves");
	...
	if(self.pers["allow_soh"]) //Allow SOH
	{
